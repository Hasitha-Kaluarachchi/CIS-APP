...
class _OrgLoginScreenState extends State<OrgLoginScreen> {
  ...
  // previous login session if available
  ...
  // If user/organization logged in before, app shows
  // "Previous Organization account" card.
  // ──────────────────────────────────────────────
  Future<void> _checkPreviousLogin() async {
    final session = await ApiService.loadSession(role: 'organization');
  ...
  // User dont need to enter login details again.
  // ──────────────────────────────────────────────
  ...
  // ──────────────────────────────────────────────
  // ORGANIZATION LOGIN
  // First validates input fields.
  // If email/password format is wrong, API will not be called.
  // ──────────────────────────────────────────────
  Future<void> _loginOrganization() async {
    ...
    final response = await ApiService.orgLogin(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Enter your organization email and password to continue',
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(context, AppRoutes.orgSignup);
                      },
                      child: const Text(
                        'Sign Up',
                        style: TextStyle(
  ...
  // Shows only when a saved login token exists.
  // ──────────────────────────────────────────────
        ...
        children: [
          ...
          Text(
            email == null || email.isEmpty
                ? "Continue with your saved Organization account"
                : "Continue as Organization • $email",
            style: TextStyle(
              fontSize: 14,
              color: Colors.grey.shade700,
            ),
  ...
  // Shows helpful error messages below the field.
  // ──────────────────────────────────────────────
  ...
  // ──────────────────────────────────────────────
  // PASSWORD FIELD
  // Validates empty password and short password.
  // User can show/hide password using eye icon.
  // ──────────────────────────────────────────────
